...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.fly1), 16, 16, 8);
            ...
            if(missileElapsed >(2000 - player.getScore()/4)){
                ...
                if(missiles.size()==0)
                {
                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.
                            missile1),WIDTH + 10, HEIGHT/2, 32, 32, player.getScore(), 6));
                }
                else
                {

                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.missile1),
                            WIDTH+10, (int)(rand.nextDouble()*(HEIGHT - (maxBorderHeight * 2))+maxBorderHeight),32,32, player.getScore(),6));
                }
    ...
    public void updateTopBorder()
    {
        ...
        {
            topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(),R.drawable.grass
            ...
            if(topborder.get(i).getX()<-20)
            {
                ...
                if(topDown)
                {
                    topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(),
                            R.drawable.grass),topborder.get(topborder.size()-1).getX()+20,
    ...
    public void updateBottomBorder()
    {
        ...
        {
            botborder.add(new BotBorder(BitmapFactory.decodeResource(getResources(), R.drawable.grass),
